...
class ScriptArguments:
    dataset: str = field(
        default="sql_create_context", metadata={"help": "the dataset to evaluate"}
    )
    ...
    max_new_tokens: int = field(
        default=1024, metadata={"help": "the maximum number of new tokens"}
    )
...
if __name__ == "__main__":
    ...
    evaluator.eval_in_batch(
        ...
        bench=args.dataset,
        evaluator=args.evaluator,  # max_eval_samples = 100,
