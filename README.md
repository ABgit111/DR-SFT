...
## Datasets
Due to license permissions, we can't release the modified dataset to public. For Embedded Attack, please refer to `preprocess.ipynb` as a example to construct the datasets. Please refer to [Constrained SFT](https://github.com/Unispac/shallow-vs-deep-alignment) to get the data.
